...
| --- | --- | --- | --- | --- |
| P0 | [AR-0093](tasks/AR-0093.md): Runtime deployment and release operations | awr-worker-0093 | Make the integrated runtime installable and recoverable across supported hosts and workflow projects. | Implement reproducible packaging, deployment, upgrade, rollback, and configuration migration. |
