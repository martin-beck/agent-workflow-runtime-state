...
flowchart LR
    ...
    subgraph series_01["01 - Contracts and runtime"]
        ...
        AR_0134["AR-0134 - In progress"]:::status_in_progress
...
| --- | --- | --- | --- | --- |
| P0 | [AR-0134](tasks/AR-0134.md): Worker monitoring and recovery control | awr-exec-0134 | Continuously monitor and control spawned workers, including cancellation and crash recovery. | Implement and verify: live worker monitoring, cancellation, heartbeat, and recovery controller. |
