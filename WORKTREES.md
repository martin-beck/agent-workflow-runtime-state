...
| --- | --- | --- | ---: | --- |
| `agent-workflow-runtime` | `main` | `88f841588381` | 9 | behind 0, ahead 22 |
| changed files | - | - | - | `README.md`, `docs/ARCHITECTURE.md`, `docs/PROTOCOL.md`, `scripts/check_opendesk_adapter.py`, `scripts/opendesk_adapter.py`, `specifications/README.md`, `specifications/fixtures/opendesk-trace-ar0017-v1.json`, `specifications/opendesk-adapter-v1.json`, `tests/test_opendesk_adapter.py` |
