...
| --- | --- | --- | --- | --- |
| P0 | [AR-0085](tasks/AR-0085.md): Multi-agent executable adapter sessions | awr-worker-0085 | Make multiple agent profiles concurrently executable behind one bounded lifecycle and local-mock response boundary. | Implement executable provider-neutral adapter sessions over the supervised local transport. |
