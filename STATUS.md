...
| --- | --- | --- | --- | --- |
| P1 | [AR-0019](tasks/AR-0019.md): Capability broker and worktree enforcement | awr-worker-0019 | Implement capability grants, tool boundaries, isolated worktrees, project bindings, and fail-closed enforcement. | Write and check the versioned specification, then implement only after review. |
| P1 | [AR-0020](tasks/AR-0020.md): Evidence and oracle bridge implementation | awr-worker-0020 | Implement AWQ evidence submission and AWG batched oracle interaction with revision-bound decisions and reusable guidance. | Write and check the versioned specification, then implement only after review. |
