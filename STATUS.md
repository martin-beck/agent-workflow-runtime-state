...
flowchart LR
    ...
    subgraph series_01["01 - Contracts and runtime"]
        ...
        AR_0137["AR-0137 - In progress"]:::status_in_progress
...
| --- | --- | --- | --- | --- |
| P0 | [AR-0137](tasks/AR-0137.md): End-to-end autonomous project run with local agents | awr-exec-0137 | Run multiple interacting fake agents through the complete autonomous loop on a new complex project. | Implement and verify: provider-free multi-agent autonomous project execution. |
