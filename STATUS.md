...
| --- | --- | --- | --- | --- |
| P1 | [AR-0106](tasks/AR-0106.md): Multi-project operation | awr-worker-0106 | Support safe operation across multiple independent runtime-enabled projects. | Implement and verify: Multi-project operation. |
