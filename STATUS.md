...
| --- | --- | --- | --- | --- |
| P0 | [AR-0104](tasks/AR-0104.md): New-project bootstrap | awr-worker-0104 | Make it straightforward to create and register a new runtime-enabled project from a clean directory. | Implement and verify: New-project bootstrap. |
