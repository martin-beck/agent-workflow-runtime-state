...
| --- | --- | --- | ---: | --- |
| `agent-workflow-runtime` | `main` | `aade520cccf9` | 0 | behind 0, ahead 10 |
...
| `agent-workflow-runtime-0006` | `feature/ar-0006` | `aade520cccf9` | 8 | behind 0, ahead 10 |
| changed files | - | - | - | `docs/ARCHITECTURE.md`, `docs/PROTOCOL.md`, `scripts/check_resource_boundary.py`, `scripts/resource_boundary.py`, `specifications/README.md`, `specifications/fixtures/resource-trace-ar0006-v1.json`, `specifications/resource-boundary-v1.json`, `tests/test_resource_boundary.py` |
