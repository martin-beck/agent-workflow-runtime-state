...
| --- | --- | --- | --- | --- |
| P0 | [AR-0005](tasks/AR-0005.md): Supervisor admission, lease, and worker lifecycle | awr-worker-0005 | Define admission, leases, heartbeats, cancellation, handoff, stale-worker recovery, and lifecycle state transitions. | Write and check the versioned specification, then implement only after review. |
