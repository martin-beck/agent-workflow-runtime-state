...
| --- | --- | --- | --- | --- |
| P0 | [AR-0058](tasks/AR-0058.md): Deployment and release implementation | awr-worker-0058 | Make the runtime installable, deployable, upgradeable, and recoverable across supported hosts and workflow projects. | Implement production packaging, deployment, compatibility, upgrade, rollback, and release automation. |
