...
flowchart LR
    ...
    subgraph series_01["01 - Contracts and runtime"]
        ...
        AR_0119["AR-0119 - In progress"]:::status_in_progress
...
| --- | --- | --- | --- | --- |
| P0 | [AR-0119](tasks/AR-0119.md): Concurrent multi-agent qualification | awr-worker-0119 | Prove safe and efficient operation of heterogeneous agents on a large software system workload. | Implement and verify: concurrent multi-agent and multi-project qualification. |
