...
flowchart LR
    ...
    subgraph series_01["01 - Contracts and runtime"]
        ...
        AR_0132["AR-0132 - In progress"]:::status_in_progress
...
| --- | --- | --- | --- | --- |
| P0 | [AR-0132](tasks/AR-0132.md): Interactive agent-session protocol | awr-exec-0132 | Interact with spawned agent sessions through bounded normalized messages and streaming events. | Implement and verify: bidirectional provider-neutral agent-session interaction. |
